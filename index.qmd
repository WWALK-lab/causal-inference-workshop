...
1. What disturbance type has the biggest impact on snowshoe hare abundance? 

## Example: building the DAG

![](presentation_imgs/DAG.png)
...
![](presentation_imgs/adjustmentset.png)
...
## Example: asking another question{.scrollable}

Q2: What are the effects of different disturbance types?  

![](presentation_imgs/adjustmentset2.png)
```{r}
#| echo: true
#| eval: false
